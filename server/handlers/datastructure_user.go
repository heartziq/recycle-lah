...
// type UserInfoResponse2 struct defines the data format
// sent to the REST API client.
type UserInfoResponse2 struct {
	Success   bool   `json:"success"`
	Timestamp int    `json:"timestamp"`
	Message   string `json:"message"`
	UserInfo2
...
// type UserInfo2 struct include token
type UserInfo2 struct { // follows database structure
	Token        string `json:"token"`
	Id           string `json:"id"`
	password     string
	Email        string    `json:"code"`
